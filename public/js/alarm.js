...
storage.set('youtube-id', 'jeJrQ1a2M7s');
...
var instance = function(){
	...
	first_d.className = "input-group";

	var right = document.createElement('div');
	right.className = "progress-bar progress-bar-success";
    ...
    var despLabel = document.createElement('input');
    despLabel.type='text';
    despLabel.className = 'form-control';
    despLabel.placeholder = 'Additional Info';
    first_d.appendChild(icon);
    first_d.appendChild(despLabel);
    
    this.progress.appendChild(right);
    //this.progress.appendChild(this.check);
    this.dom.appendChild(first_d);
    this.dom.appendChild(this.progress);
